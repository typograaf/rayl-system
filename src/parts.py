...
OPEN = [
 ...
 ("Magnetism on buttons", "PROVISIONAL",
  "the slider's lean, applied to the nearest button and only that one",
  ...
  "one lets go, and the cap is 6 rather than 12. Six is a cluster's own gap, so "
  "a button can never close the distance to its neighbour; the nub keeps 12 "
