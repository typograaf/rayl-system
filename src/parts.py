...
OPEN = [
 ...
 ("Magnetism on buttons", "PROVISIONAL",
  ...
  "one lets go, and it moves at most 4.5 rather than 12 — three quarters of a "
  "cluster's gap, so a control never comes close to reaching its neighbour. "
  "The nub keeps 12 because it has nothing beside it.\n\n"
